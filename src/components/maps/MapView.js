...
(<a className='btn' href={`${process.env.REACT_APP_URL_MAPS}${lat},${lng}`}  target={`_blank`}>
  <i className='fas fa-user-secret' style={{ color: "red", background: "white" }} data-toggle="tooltip" data-placement="top" title={`${text} en: ${lat}, ${lng}`}></i>
</a>)
